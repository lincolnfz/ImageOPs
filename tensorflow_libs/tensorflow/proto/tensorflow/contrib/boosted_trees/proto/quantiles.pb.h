...
void AddDescriptors_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2fquantiles_2eproto();
...
class QuantileConfig :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:boosted_trees.QuantileConfig) */ {
 public:
  QuantileConfig();
...
class QuantileEntry :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:boosted_trees.QuantileEntry) */ {
 public:
  QuantileEntry();
...
class QuantileSummaryState :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:boosted_trees.QuantileSummaryState) */ {
 public:
...
class QuantileStreamState :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:boosted_trees.QuantileStreamState) */ {
 public:
  QuantileStreamState();
