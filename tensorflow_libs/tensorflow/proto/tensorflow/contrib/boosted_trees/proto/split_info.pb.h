...
void AddDescriptors_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2fsplit_5finfo_2eproto();
...
class SplitInfo :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.learner.SplitInfo) */ {
 public:
  SplitInfo();
  virtual ~SplitInfo();
...
class ObliviousSplitInfo :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.learner.ObliviousSplitInfo) */ {
 public:
  ObliviousSplitInfo();
